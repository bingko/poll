...
<?php echo form_open('ci_login/login')?>
        <table width="90%" align="center" cellpadding="4" cellspacing="4" class="table_radius">
          	  <tr>
                <td align="center"><br>
                      <img src="<?php echo base_url()?>images/header/logo_mobile.png" width="70%" height="" />
                      </td>
              </tr>
              <tr>
        ...
        <table width="95%" align="center" cellpadding="3" cellspacing="3" class="table_radius">
          <tr>
            <td height="40" colspan="2" align="center"><strong style="font-size:25px;">Login</strong></td>
            </tr>
          <tr>
            <td width="26%">Username</td>
            <td width="74%" height="40"><input type="text" name="username" id="username" class="k-textbox" style="width:80%; height:50px;" required validationMessage="" /></td>
          </tr>
          <tr>
            <td>Password</td>
            <td height="40"><input type="password" name="password" id="password" class="k-textbox" style="width:80%; height:50px;" required validationMessage="" /></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td height="40" ><input type="submit" name="button" id="button" value="เข้าสู่ระบบ" class="k-button"  style="width:80%; height:70px;"  /></td>
          </tr>
        </table>
