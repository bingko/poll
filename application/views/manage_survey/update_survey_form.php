...
?>
<h2>&nbsp;&nbsp;สร้างแบบสอบถามใหม่</h2><br />
<div align="center"><p><?php echo anchor_popup('report/review','<input type="button" class="k-button" value="แสดงตัวอย่าง" style="width:150px;"/>',$popup_review);?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo anchor('survey/option_survey','<input type="button" class="k-button" value="ตั้งค่าแบบสอบถามและบันทึกข้อมูล"/>');?></p></div>
    ...
    <table width="90%" align="center" cellpadding="2" cellspacing="2" class="survey_layer">
      <tr>
		...
		<?php for ($i = 0; $i < count(@$_SESSION['data_respondent']); $i++){?>
            ...
            <?php } ?>
        <?php } ?>
        <p><div align="center" style="color:#CCCCCC; font-size:22px;">พื้นที่ข้อมูลทั่วไป ของแบบสำรวจ</div></p>
        </td>
      </tr>
    </table>
      ...
      <tr>
		...
		<?php for($i=0;$i<count(@$_SESSION['qa_all']);$i++){?>
			...
			if(@$_SESSION['qa_all'][$i]['type']=="mulitiple_only"){ 
				...
				echo anchor('ci_manage_survey/edit_session/'.$i.'','<img src="'.base_url().'images/update_icon.png" width="20"/> ').anchor('ci_manage_survey/unset_session/'.$i.'','<img src="'.base_url().'images/delete_icon.png" width="20"/>')."<br>";
				echo "<textarea name='' id='' style='width:50%; height:80px;' class='k-textbox'></textarea>"."<br><hr style='border:solid 1px #000000;'>";
            	echo "</td></tr>";
				...
				$arr = @split('/',$date);//ตัด array โดยหา data จาก สัญญาลักณ์ /
				for($k=0;$k<count($arr);$k++){
				echo "<tr><td bgcolor='#F4F4F4'>".$arr[$k]."</td>";
				$date = str_replace("\n","/",@$_SESSION['qa_all'][$i]['ranking_matrix_multiple']);//เปลี่ยนจาก \n เป็น /
				$arr = @split('/',$date);//ตัด array โดยหา data จาก สัญญาลักณ์ /
				for($n=0;$n<count($arr);$n++){
    ...
    <table width="100%" align="center" class="table_radius">
          <tr>
            ...
            <p>&nbsp;
            	<a style="cursor:pointer;" onclick="showPage('#home_page5')"><img src="<?php echo base_url()?>images/icon_menu/icon_5.png" width="15"/> ตัวเลือกอันดับแบบกำหนดเกณฑ์</a>
            </p>
            <p>&nbsp;
            ...
            <p>&nbsp;
            	<a style="cursor:pointer;" onclick="showPage('#home_page10')"><img src="<?php echo base_url()?>images/icon_menu/icon_10.png" width="15"/> วันเวลา</a>
            </p>
            </td>
            ...
            <p><table width="95%" align="center">
              ...
              <tr>
                <td><input name="question_mulitiple_only" id="question_mulitiple_only" type="text" class="k-textbox" style="width:100%"" /></td>
              </tr>
			  <tr>
                <td><strong>คำตอบ</strong></td>
              </tr>
			  <tr>
                <td><textarea name="answer_mulitiple_only" id="answer_mulitiple_only" class="k-textbox" style="width:100%; height:200px;"></textarea></td>
              </tr>
			  <tr>
			  ...
			  <tr>
                <td align="right">
                <input name="submit" id="submit" type="submit" value=" บันทึก " class="k-button" style="width:150px;"/>&nbsp;&nbsp;
                <a href = "javascript:void(0)" onclick = "document.getElementById('light_question').style.display='none';document.getElementById('fade').style.display='none'"><input type="reset" name="button3" id="button3" value="ยกเลิก" class="k-button" style="width:150px;"/></a>
              </td>
            </tr>
            </table></p>
            <?php echo form_close()?>
            ...
            <p><table width="95%" align="center">
              ...
              <tr>
                <td><input name="question_mulitiple_multiple" id="question_mulitiple_multiple" type="text" class="k-textbox" style="width:100%"" /></td>
              </tr>
			  <tr>
                <td><strong>คำตอบ</strong></td>
              </tr>
			  <tr>
                <td><textarea name="answer_mulitiple_multiple" id="answer_mulitiple_multiple" class="k-textbox" style="width:100%; height:200px;"></textarea></td>
              </tr>
              <tr>
            ...
            <p><table width="95%" align="center">
              ...
              <tr>
                <td><input name="comment" id="comment" type="text" class="k-textbox" style="width:100%;" /></td>
              </tr>
			  <tr>
            ...
            <p><table width="95%" align="center">
              ...
              <tr>
                <td><input name="question_ranking" id="question_ranking" type="text" class="k-textbox" style="width:100%"" /></td>
              </tr>
			  <tr>
                <td><strong>คำตอบ</strong></td>
              </tr>
			  <tr>
                <td><textarea name="answer_ranking" id="answer_ranking" class="k-textbox" style="width:100%; height:200px;"></textarea></td>
              </tr>
              <tr>
            ...
            <p><table width="95%" align="center">
              <tr>
                <td><strong>ประเภท ตัวเลือกอันดับแบบกำหนดเกณฑ์</strong></td>
              </tr>
              <tr>
                <td><strong>คำถาม</strong></td>
              </tr>
			...
			<tr>
				<td width="100%"><textarea name="ranking_scale" id="ranking_scale" cols="35" rows="8" class="k-textbox" style="width:100%;"></textarea></td>
			</tr>
             <tr>
             	<td><strong>ค่าน้ำหนัก</strong></td>
             </tr>
			<tr>
				<td width="100%"><textarea name="ranking_scale_weight" id="ranking_scale_weight" cols="35" rows="8" class="k-textbox" style="width:100%;"></textarea></td>
			</tr>
 			  <tr>
            ...
            <p><table width="95%" align="center">
              ...
              <tr>
                <td><input name="question_matrix_only" id="question_matrix_only" type="text" class="k-textbox" style="width:100%"" /></td>
              </tr>
              <tr>
                  <td></td>
			  <tr>
            ...
            <p><table width="95%" align="center">
              ...
              <tr>
                <td><input name="question_matrix_multiple" id="question_matrix_multiple" type="text" class="k-textbox" style="width:100%"" /></td>
              </tr>
              <tr>
                  <td></td>
			  <tr>
            ...
            <p><table width="95%" align="center">
              <tr>
                <td><strong>ปรเภท คำถามคำตอบแบบสั้น</strong></td>
              </tr>
              <tr>
                <td><strong>คำถาม</strong></td>
              </tr>
              <tr>
				<td><input name="question_single_textbox" id="question_single_textbox" type="text" class="k-textbox" style="width:100%"" /></td>
              </tr>
              <tr>
            ...
            <p><table width="95%" align="center">
              ...
              <tr>
                <td><input name="question_mulitple_textbox" id="question_mulitple_textbox" type="text" class="k-textbox" style="width:100%"" /></td>
              </tr>
				<tr>
                <td><strong>คำตอบ</strong></td>
              </tr>
            ...
            <p><table width="95%" align="center">
              ...
              <tr>
                <td>
                <input name="question_date_time" id="question_date_time" type="text" class="k-textbox" style="width:100%" />
                </td>
              </tr>
              <tr>
                <td><strong>คำตอบ</strong></td>
