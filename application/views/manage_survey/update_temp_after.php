...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_radius">
  <tr>
    ...
    <div id="light_question" class="white_content_question_autopopup" align="left">
		...
		<?php echo form_open('ci_manage_temp/mulitiple_only_update_after')?>
            <p><table width="90%" align="center">
			  ...
			  <tr>
                <td><input name="submit" id="submit" type="submit" value="บันทึก" class="k-button" style="width:150px;"/> <?php echo anchor('survey/update_template','<input type="none" name="button3" id="button3" value="ยกเลิก" class="k-button" style="width:150px;"/>');?><input name="chanel" id="chanel" type="hidden" value="<?php echo $arr; ?>" /></td>
              </tr>
            </table></p>
		<?php echo form_close();?>
        <?php } ?>
        <?php $arr = $this->uri->segment(3);if($_SESSION['temp_all'][$arr]['type']=="mulitiple_multiple"){?>
        <?php echo form_open('ci_manage_temp/mulitiple_multiple_update_after')?>
		...
		<?php echo form_open('ci_manage_temp/comment_update_after')?>
            <table width="90%" align="center">
              <tr>
        ...
        <?php echo form_open('ci_manage_temp/ranking_update_after')?>
            <p><table width="90%" align="center">
              <tr>
        ...
        <?php echo form_open('ci_manage_temp/ranking_scale_update_after')?>
		<table width="90%" align="center">
              <tr>
			...
			<tr>
				<td width="70%"><textarea name="ranking_scale" id="ranking_scale" cols="35" rows="8" class="k-textbox" style="width:100%;"><?php echo @$_SESSION['temp_all'][$arr]['ranking_scale']?></textarea></td>
			</tr>
             <tr>
             	<td><strong>ค่าน้ำหนัก</strong></td>
             </tr>
			<tr>
				<td width="70%"><textarea name="ranking_scale_weight" id="ranking_scale_weight" cols="35" rows="8" class="k-textbox" style="width:100%;"><?php echo @$_SESSION['temp_all'][$arr]['ranking_scale_weight']?></textarea></td>
			</tr>
 			  <tr>
        ...
        <?php echo form_open('ci_manage_temp/matrix_only_update_after')?>
            <table width="90%" align="center">
              <tr>
                <td><strong>ประเภท คำถามแบบเลือกตอบ 1 คำตอบในรูปแบบเมตริก</strong></td>
              </tr>
              <tr>
                <td><input name="question_matrix_only" id="question_matrix_only" type="text" class="k-textbox" style="width:100%"  value="<?php echo @$_SESSION['temp_all'][$arr]['question_matrix_only']?>" /></td>
              </tr>
              <tr>
                  <td></td>
			  <tr>
        ...
        <?php echo form_open('ci_manage_temp/matrix_multiple_update_after')?>
            <table width="90%" align="center">
              <tr>
                <td><strong>ประเภท คำถามแบบเลือกหลายคำตอบในรูปแบบเมตริก</strong></td>
              </tr>
              <tr>
                <td><input name="question_matrix_multiple" id="question_matrix_multiple" type="text" class="k-textbox" style="width:100%" value="<?php echo @$_SESSION['temp_all'][$arr]['question_matrix_multiple']?>" /></td>
              </tr>
              <tr>
                  <td></td>
			  <tr>
        ...
        <?php echo form_open('ci_manage_temp/single_textbox_update_after')?>
            <table width="90%" align="center">
            <tr>
              ...
              <tr>
                <td><input name="question_single_textbox" id="question_single_textbox" type="text" class="k-textbox" style="width:100%" value="<?php echo @$_SESSION['temp_all'][$arr]['question_single_textbox']?>" /></td>
              </tr>
              <tr>
        ...
        <?php echo form_open('ci_manage_temp/mulitple_textbox_update_after')?>
            <table width="90%" align="center">
                        <tr>
              ...
              <tr>
                <td><input name="question_mulitple_textbox" id="question_mulitple_textbox" type="text" class="k-textbox" style="width:100%" value="<?php echo @$_SESSION['temp_all'][$arr]['question_mulitple_textbox']?>" /></td>
              </tr>
              <tr>
                <td><strong>คำตอบ</strong></td>
              </tr>
        ...
        <?php echo form_open('ci_manage_temp/date_time_update_after')?>
            <p><table width="90%" align="center">
                                    <tr>
              ...
              <tr>
                <td><input name="question_date_time" id="question_date_time" type="text" class="k-textbox" style="width:100%" value="<?php echo @$_SESSION['temp_all'][$arr]['question_date_time']?>" /></td>
              </tr>
        <tr>
                <td><strong>คำตอบ</strong></td>
              </tr>
