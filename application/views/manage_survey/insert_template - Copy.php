...
?>
      ...
      <div align="center">
        <p><?php echo anchor('ci_manage_temp/insert_question_answer','<input type="button" class="k-button" value="บันทึก" style="width:150px;"/>');?></p>
        </div>
      <P></P>
        ...
        <tr>
          <td height="35"><table width="100%" align="center">
			...
			if(@$_SESSION['qa_all'][$i]['type']=="mulitiple_only"){ 
				...
				echo anchor('ci_manage_temp/edit_session/'.$i.'','<img src="'.base_url().'images/update_icon.png" width="20"/>  ').anchor('ci_manage_temp/unset_session/'.$i.'','<img src="'.base_url().'images/delete_icon.png" width="20"/>' , array('onClick' => "return confirm('คุณต้องการที่จะลบคำถามใช่หรือไม่?')"));
...
<?php }}} ?>
  ...
  <table id="grid">
                <thead>
                    <tr>
                        <th data-field="title"><div align="center"><strong>ชื่อคำถาม</strong></div></th>
                ...
                <?php foreach($survey_list as $survey_list){?>
            		<tr>
						...
						<td><?php echo anchor('survey/list_detail/'.$survey_list['qh_id'].'','<input name="submit" type="submit" class="k-button" value="รายงาน"/>')?><?php echo anchor('ci_manage_survey/update_survey_db/'.$survey_list['qh_id'].'','<input name="Submit" type="submit" value="แก้ไขข้อมูล" class="k-button" />');?><?php echo anchor('ci_manage_survey/delete_survey_db/'.$survey_list['qh_id'].'','<input name="Submit" type="submit" value="ลบข้อมูล" class="k-button"/>' , array('onClick' => "return confirm('คุณต้องการลบแบบสอบถามใช่หรือไม่?')"));?></td>
					</tr>
                <?php } ?>
                </tbody>
            </table>
