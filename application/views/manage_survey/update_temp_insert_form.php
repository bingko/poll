...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_radius">
  <tr>
    ...
    <div id="light_question" class="white_content_question_autopopup" align="left">
		...
		<?php echo form_open('ci_manage_temp/mulitiple_only_update_insertform')?>
        ...
        <?php echo form_open('ci_manage_temp/mulitiple_multiple_update_insertform')?>
		...
		<?php echo form_open('ci_manage_temp/comment_update_insertform')?>
            <table width="90%" align="center">
              <tr>
        ...
        <?php echo form_open('ci_manage_temp/ranking_update_insertform')?>
            <p><table width="90%" align="center">
              <tr>
        ...
        <?php echo form_open('ci_manage_temp/ranking_scale_update_insertform')?>
		<table width="90%" align="center">
              <tr>
        ...
        <?php echo form_open('ci_manage_temp/matrix_only_update_insertform')?>
            <table width="90%" align="center">
              <tr>
        ...
        <?php echo form_open('ci_manage_temp/matrix_multiple_update_insertform')?>
            <table width="90%" align="center">
              <tr>
        ...
        <?php echo form_open('ci_manage_temp/single_textbox_update_insertform')?>
            <table width="90%" align="center">
            <tr>
        ...
        <?php echo form_open('ci_manage_temp/mulitple_textbox_update_insertform')?>
            <table width="90%" align="center">
            <tr>
        ...
        <?php echo form_open('ci_manage_temp/date_time_update_insertform')?>
            <p><table width="90%" align="center">
                        <tr>
