...
<table width="95%" border="0" align="center" cellpadding="3" cellspacing="3" class="table_radius" >
  <tr>
    <td height="50" bgcolor="#CCCCCC"><div class="alert"><strong>&nbsp;&nbsp;สร้างแบบสอบถามใหม่</strong></div></td>
  </tr>
  <tr>
...
?>
      <div align="center">
        <p><?php echo anchor_popup('report/review','<input type="button" class="k-button" value="แสดงตัวอย่าง" style="width:150px;"/>',$popup_review);?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo anchor('survey/option_survey','<input type="button" class="k-button" value="ตั้งค่าแบบสอบถามและบันทึกข้อมูล" />');?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo anchor('home','<input type="button" class="k-button" value="ยกเลิก" style="width:150px;"/>');?></p>
      </div>
      ...
      <div id="light_title" class="white_content_title" align="left"> <?php echo form_open('ci_manage_survey/list_data_create')?>
	...
	<script language=Javascript>
      ...
      if(@$_SESSION['temp_all'][$i]['type']=="mulitiple_only"){ 
        ...
        echo anchor('ci_manage_temp/edit_session/'.$i.'','<img src="'.base_url().'images/update_icon.png" width="20"/>  ').anchor('ci_manage_temp/unset_session/'.$i.'','<img src="'.base_url().'images/delete_icon.png" width="20"/>' , array('onClick' => "return confirm('คุณต้องการลบคำถามใช่หรือไม่?')"));
      ...
      if(@$_SESSION['data_respondent'][$i]==1){
        ...
        <table width="90%" align="center" cellpadding="2" cellspacing="2">
          ...
          <tr>
            <td height="35" colspan="6" align="right"><br />
        ...
        <?php echo form_close()?> </div>
      <div id="light_category_temp" class="white_content_category" align="left"> <?php echo form_open('ci_manage_temp/select_temp')?> 
        <!--  ปิดแทรกTemplate   --> 
        
        <?php echo form_open('ci_manage_temp/select_temp')?>
        <table width="90%" border="0" cellpadding="2" cellspacing="2" align="center">
          <tr>
            <td><table id="grid_temp">
                <thead>
                  <tr>
        ...
        <p> <a href="javascript:window.close();">
          <input name="" type="submit" value="เลือก" class="k-button" style="width:150px;">
          </a><a href = "javascript:void(0)" onclick = "document.getElementById('light_category_temp').style.display='none';document.getElementById('fade').style.display='none'">
      ...
      if(@$_SESSION['qa_all'][$i]['type']=="mulitiple_only"){ 
        if(@$_SESSION['qa_all'][$i]['check_mulitiple_only']!=""){$mark_mulitiple_only[$i] = "<span style='color:red;'>*</span>";}
        echo "<tr><td bgcolor='#CCCCCC'><strong style='font-size:18px;'>คำถาม :&nbsp;&nbsp;</strong>";
        ...
        if(@$_SESSION['qa_all'][$i]['check_mulitiple_multiple']!=""){$mark_mulitiple_multiple[$i] = "<span style='color:red;'>*</span>";}
        echo "<tr><td bgcolor='#CCCCCC'><strong style='font-size:18px;'>คำถาม :&nbsp;&nbsp;</strong>";
        ...
        if(@$_SESSION['qa_all'][$i]['check_comment']!=""){$mark_comment[$i] = "<span style='color:red;'>*</span>";}
        echo "<tr><td bgcolor='#CCCCCC'><strong style='font-size:18px;'>คำถาม :&nbsp;&nbsp;</strong>";
        ...
        if(@$_SESSION['qa_all'][$i]['check_ranking']!=""){$mark_ranking[$i] = "<span style='color:red;'>*</span>";}
        echo "<tr><td bgcolor='#CCCCCC'><strong style='font-size:18px;'>คำถาม :&nbsp;&nbsp;</strong>";
        ...
        if(@$_SESSION['qa_all'][$i]['check_ranking_scale']!=""){$mark_ranking_scale[$i] = "<span style='color:red;'>*</span>";}
        echo "<tr><td bgcolor='#CCCCCC'><strong style='font-size:18px;'>คำถาม :&nbsp;&nbsp;</strong>";
        ...
        if(@$_SESSION['qa_all'][$i]['check_matrix_only']!=""){$mark_matrix_only[$i] = "<span style='color:red;'>*</span>";}
        echo "<tr><td bgcolor='#CCCCCC'><strong style='font-size:18px;'>คำถาม :&nbsp;&nbsp;</strong>";
        ...
        if(@$_SESSION['qa_all'][$i]['check_matrix_multiple']!=""){$mark_matrix_multiple[$i] = "<span style='color:red;'>*</span>";}
        echo "<tr><td bgcolor='#CCCCCC'><strong style='font-size:18px;'>คำถาม :&nbsp;&nbsp;</strong>";
        ...
        if(@$_SESSION['qa_all'][$i]['check_single_textbox']!=""){@$mark_single_textbox[$i] = "<span style='color:red;'>*</span>";}
        echo "<tr><td bgcolor='#CCCCCC'><strong style='font-size:18px;'>คำถาม :&nbsp;&nbsp;</strong>";
        ...
        if(@$_SESSION['qa_all'][$i]['check_mulitple_textbox']!=""){$mark_mulitple_textbox[$i] = "<span style='color:red;'>*</span>";}
        echo "<tr><td bgcolor='#CCCCCC'><strong style='font-size:18px;'>คำถาม :&nbsp;&nbsp;</strong>";
        ...
        if(@$_SESSION['qa_all'][$i]['check_date_time']!=""){$mark_date_time[$i] = "<span style='color:red;'>*</span>";}
        echo "<tr><td bgcolor='#CCCCCC'><strong style='font-size:18px;'>คำถาม :&nbsp;&nbsp;</strong>";
        echo @$mark_date_time[$i]."<strong style='font-size:18px;'>".@$_SESSION['qa_all'][$i]['question_date_time'];
        echo anchor('ci_manage_survey/edit_session/'.$i.'','<img src="'.base_url().'images/update_icon.png" width="20"/>  ').anchor('ci_manage_survey/unset_session/'.$i.'','<img src="'.base_url().'images/delete_icon.png" width="20"/>' , array('onClick' => "return confirm('คุณต้องการที่จะลบคำถามใช่หรือไม่?')"));
        echo "<br></td></tr><tr><td><br>";
