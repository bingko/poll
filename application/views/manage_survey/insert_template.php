...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table_radius">
  <tr>
      ...
      <div align="center">
        <p><?php echo anchor('ci_manage_temp/insert_temp_db','<input type="button" class="k-button" value="บันทึก" style="width:150px;"/>' , array('onClick' => "return confirm('คุณต้องการบันทึกใช่หรือไม่?')"));?></p>
        </div>
      <P></P>
      ...
      <table width="90%" align="center" cellpadding="2" cellspacing="2" class="table_radius">
        ...
        <tr>
          ...
          <td width="79%" height="35"><input type="text" readonly="readonly" value="<?php echo @$all_session['heading']['temp_title']?>" class="k-textbox" style="width:90%;" /></td>
        </tr>
        <tr>
          <td height="35"><strong>รายละเอียดคำถามที่ใช้บ่อย</strong></td>
          <td height="35"><textarea name="temp_detail" id="temp_detail" cols="45" rows="3" class="k-textbox" style="width:90%;" readonly="readonly"><?php echo @$all_session['heading']['temp_detail']?></textarea></td>
        </tr>        
        <tr><td><p></p></td></tr>
      </table>
      <p></p>
	   ...
	   <?php echo form_open('ci_manage_temp/list_data_create')?>
        <table width="90%" align="center" cellpadding="2" cellspacing="2">
          ...
          <tr>
            <td height="35"><strong>หัวข้อแบบสอบถาม</strong>
              <input type="text" name="temp_title" id="temp_title" class="k-textbox" style="width:100%;" value="<?php echo @$all_session['heading']['temp_title']?>"/></td>
          </tr>
          <tr>
            <td height="35" valign="top"><strong>รายละเอียดแบบสอบถาม</strong>
              <textarea name="temp_detail" id="temp_detail" cols="45" rows="3" class="k-textbox" style="width:100%;"><?php echo @$all_session['heading']['temp_detail']?></textarea></td>
          </tr>
          <tr>
        ...
        <tr>
          <td height="35"><table width="100%" align="center">
			...
			if(@$_SESSION['temp_all'][$i]['type']=="mulitiple_only"){ 
				...
				echo anchor('ci_manage_temp/edit_temp/'.$i.'','<img src="'.base_url().'images/update_icon.png" width="20"/>  ').anchor('ci_manage_temp/unset_temp/'.$i.'','<img src="'.base_url().'images/delete_icon.png" width="20"/>' , array('onClick' => "return confirm('คุณต้องการที่จะลบคำถามใช่หรือไม่?')"));
        ...
        <table width="100%" align="center" class="table_radius">
          <tr>
            ...
            <td width="70%" valign="top" ><div id="midRight">
                ...
                <div id="home_page1" style="display:none;"> <?php echo form_open('ci_manage_temp/mulitiple_only')?>
                  <p>
                  <table width="95%" align="center">
                    <tr>
                  ...
                  <?php echo form_close()?> </div>
                <div id="home_page2" style="display:none;"> <?php echo form_open('ci_manage_temp/mulitiple_multiple')?>
                  <p>
                  <table width="95%" align="center">
                    <tr>
                  ...
                  <?php echo form_close()?> </div>
                <div id="home_page3" style="display:none;"> <?php echo form_open('ci_manage_temp/comment')?>
                  <p>
                  <table width="95%" align="center">
                    <tr>
                  ...
                  <?php echo form_close()?> </div>
                <div id="home_page4" style="display:none;"> <?php echo form_open('ci_manage_temp/ranking')?>
                  <p>
                  <table width="95%" align="center">
                    <tr>
                  ...
                  <?php echo form_close()?> </div>
                <div id="home_page5" style="display:none;"> <?php echo form_open('ci_manage_temp/ranking_scale')?>
                  <p>
                  <table width="95%" align="center">
                    <tr>
                  ...
                  <?php echo form_close()?> </div>
                <div id="home_page6" style="display:none;"> <?php echo form_open('ci_manage_temp/matrix_only')?>
                  <p>
                  <table width="95%" align="center">
                    <tr>
                  ...
                  <?php echo form_close()?> </div>
                <div id="home_page7" style="display:none;"> <?php echo form_open('ci_manage_temp/matrix_multiple')?>
                  <p>
                  <table width="95%" align="center">
                    <tr>
                  ...
                  <?php echo form_close()?> </div>
                <div id="home_page8" style="display:none;"> <?php echo form_open('ci_manage_temp/single_textbox')?>
                  <p>
                  <table width="95%" align="center">
                    <tr>
                  ...
                  <?php echo form_close()?> </div>
                <div id="home_page9" style="display:none;"> <?php echo form_open('ci_manage_temp/mulitple_textbox')?>
                  <p>
                  <table width="95%" align="center">
                    <tr>
                  ...
                  <?php echo form_close()?> </div>
                <div id="home_page10" style="display:none;"> <?php echo form_open('ci_manage_temp/date_time')?>
                  <p>
                  <table width="95%" align="center">
                    <tr>
