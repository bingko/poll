...
<table width="95%" border="0" align="center" cellpadding="3" cellspacing="3" class="table_radius" >
  <tr>
    ...
    <div class="alert"><strong>&nbsp;&nbsp;แก้ไขข้อมูลแบบสอบถาม</strong></div>
    </td>
  </tr>  <tr>
    <td valign="top"  background="<?php echo base_url()?>images/bg_survey.png">
<?php 
    $popup_review = array(
        'width'      => '900',
        'height'     => '800',
...
?>
<div align="center"><p><?php echo anchor_popup('report/review','<input type="button" class="k-button" value="แสดงตัวอย่าง" style="width:150px;"/>',$popup_review);?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo anchor('survey/option_survey_after','<input type="button" class="k-button" value="ตั้งค่าแบบสอบถามและบันทึกข้อมูล" />');?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo anchor('home','<input type="button" class="k-button" value="ยกเลิกการแก้ไข" style="width:150px;"/>');?></p></div>
    ...
    <?php echo form_open('ci_manage_survey/list_data_create_update')?>
    ...
    <table width="90%" align="center" cellpadding="0" cellspacing="0">
      ...
      <td align="right"><a href = "javascript:void(0)" onclick = "document.getElementById('light_category_temp').style.display='block';document.getElementById('fade').style.display='block'">
            <input type="submit" name="button10" id="button10" value="เพิ่มคำถามที่ใช้บ่อย" class="k-button" />
            </a>
            <div id="fade2" class="black_overlay"></div></td>
      </tr>
    </table>
    <table width="90%" align="center" cellpadding="2" cellspacing="2" class="survey_layer">
      <tr>
        ...
        <?php for ($i = 0; $i < count(@$_SESSION['data_respondent']); $i++){?>
            ...
            <input name="" type="radio" />รับราชการ / พนักงานรัฐวิสาหกิจ</td><td>
            <input name="" type="radio" />นักเรียน / นักศึกษา</td><td>
            <input name="" type="radio" />พนักงานบริษัทเอกชน</td><td>
            <input name="" type="radio" />ค้าขาย / ธุรกิจส่วนตัว</td></tr><tr><td>
            <input name="" type="radio" />รับจ้างทั่วไป/ใช้แรงงาน</td><td>
            <input name="" type="radio" />พ่อบ้าน/แม่บ้าน</td><td>
            <input name="" type="radio" />เกษตรกรรม</td><td>
            <input name="" type="radio" />อื่นๆ</td></tr></table>
            <?php }if(@$_SESSION['data_respondent'][$i]==4){?>
            <strong>รายได้ส่วนตัวเฉลี่ยนต่อเดือน</strong>
            <table width="750"><tr><td>
            <input name="" type="radio" />ไม่เกิน 5,000 บาท</td><td>
            <input name="" type="radio" />5,001 - 10,000 บาท</td><td>
            <input name="" type="radio" />10,001 - 15,000 บาท</td></tr><tr><td>
            <input name="" type="radio" />15,001 - 20,000 บาท</td><td>
            <input name="" type="radio" />20,001 - 40,000 บาท</td><td>
            <input name="" type="radio" />มากกว่า 40,001 บาทขึ้นไป</td></tr></table>
            <?php }if(@$_SESSION['data_respondent'][$i]==5){?>
            <strong>การศึกษา</strong>
            <table width="750"><tr><td>
             <input name="" type="radio" />ประถมศึกษา / หรือต่ำกว่า</td><td>
             <input name="" type="radio" />มัธยมศึกษาตอนต้น</td><td>
             <input name="" type="radio" />มัธยมศึกษาตอนปลาย / ปวช.</td></tr><tr><td>
             <input name="" type="radio" />อนุปริญญา / ปวส.</td><td>
             <input name="" type="radio" />ปริญญาตรี</td><td>
             <input name="" type="radio" />ปริญญาโท / ปริญญาเอก</td></tr></table>
    ...
    <?php } ?>   
              <tr>
                <td><p>
                  <div align="center" style="color:#CCCCCC; font-size:22px;">พื้นที่แทรกข้อมูลทั่วไป</div>
                  </p></td>
              </tr>
            </table></td>
        </tr>
    ...
    <div id="light_category" class="white_content_category" align="left">
    <?php echo form_open('ci_manage_survey/list_check_category_update')?>
      ...
      <table width="90%" align="center" cellpadding="2" cellspacing="2">
        ...
        <tr>
          ...
          <td width="31%" bgcolor="#D2DBDE">ที่อยู่</td>
        </tr>
        <tr>
      ...
      <?php echo form_close()?>
            ...
            <!--  เปิดแทรกTemplate   -->
<div id="light_category_temp" class="white_content_category" align="left"> <?php echo form_open('ci_manage_temp/select_temp_after')?>
...
<p>
<a href="javascript:window.close();"><input name="" type="submit" value="เลือก" class="k-button" style="width:150px;"></a><a href = "javascript:void(0)" onclick = "document.getElementById('light_category_temp').style.display='none';document.getElementById('fade').style.display='none'">
<input type="reset" name="button11" id="button11" value="ยกเลิก" class="k-button" style="width:100px;"/>
</a></p>
      <?php echo form_close()?>
<script>
    ...
    <table width="90%" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td align="right"><a href = "javascript:void(0)" onclick = "document.getElementById('light_question').style.display='block';document.getElementById('fade').style.display='block'"><input type="submit" name="button4" id="button4" value="ตั้งคำถาม" class="k-button"/></a><div id="fade2" class="black_overlay"></div></td>
      </tr>
    </table>
    <table width="90%" align="center" cellpadding="2" cellspacing="2" class="survey_layer">
      <tr>
        ...
        <?php for($i=0;$i<count(@$_SESSION['qa_all']);$i++){?>
            ...
            if(@$_SESSION['qa_all'][$i]['type']=="mulitiple_only"){ 
                if(@$_SESSION['qa_all'][$i]['check_mulitiple_only']!=""){
					$mark_mulitiple_only[$i] = "<span style='color:red;'>*</span>";
					}
                echo "<tr><td bgcolor='#CCCCCC'><strong style='font-size:18px;'>คำถาม :&nbsp;&nbsp;</strong>";
                echo @$mark_mulitiple_only[$i]."<strong style='font-size:18px;'>".@$_SESSION['qa_all'][$i]['question_mulitiple_only']."</strong>";
                echo anchor('ci_manage_survey/edit_session_after/'.$i.'','<img src="'.base_url().'images/update_icon.png" width="20"/>  ').anchor('ci_manage_survey/unset_session_after/'.$i.'','<img src="'.base_url().'images/delete_icon.png" width="20"/>' , array('onClick' => "return confirm('คุณต้องการลบคำถามใช่หรือไม่?')"));
                echo "<br></td></tr><tr><td><br>";
                ...
                if(@$_SESSION['qa_all'][$i]['check_mulitiple_multiple']!=""){
					$mark_mulitiple_multiple[$i] = "<span style='color:red;'>*</span>";
					}
                echo "<tr><td bgcolor='#CCCCCC'><strong style='font-size:18px;'>คำถาม :&nbsp;&nbsp;</strong>";
                echo @$mark_mulitiple_multiple[$i]."<strong style='font-size:18px;'>".@$_SESSION['qa_all'][$i]['question_mulitiple_multiple']."</strong>";
                echo anchor('ci_manage_survey/edit_session_after/'.$i.'','<img src="'.base_url().'images/update_icon.png" width="20"/>  ').anchor('ci_manage_survey/unset_session_after/'.$i.'','<img src="'.base_url().'images/delete_icon.png" width="20"/>' , array('onClick' => "return confirm('คุณต้องการลบคำถามใช่หรือไม่?')"));
                echo "<br></td></tr><tr><td><br>";
                ...
                if(@$_SESSION['qa_all'][$i]['check_comment']!=""){
					$mark_comment[$i] = "<span style='color:red;'>*</span>";
					}
                echo "<tr><td bgcolor='#CCCCCC'><strong style='font-size:18px;'>คำถาม :&nbsp;&nbsp;</strong>";
                echo @$mark_comment[$i]."<strong style='font-size:18px;'>".@$_SESSION['qa_all'][$i]['comment']."</strong>";
                echo anchor('ci_manage_survey/edit_session_after/'.$i.'','<img src="'.base_url().'images/update_icon.png" width="20"/>  ').anchor('ci_manage_survey/unset_session_after/'.$i.'','<img src="'.base_url().'images/delete_icon.png" width="20"/>' , array('onClick' => "return confirm('คุณต้องการลบคำถามใช่หรือไม่?')"));
                echo "<br></td></tr><tr><td><br>";
                echo "<textarea name='' id='' style='width:75%; height:80px;' class='k-textbox'></textarea>"."<br><hr style='border:solid 1px #000000;'>";
                echo "</td></tr>";
                ...
                if(@$_SESSION['qa_all'][$i]['check_ranking']!=""){
					$mark_ranking[$i] = "<span style='color:red;'>*</span>";
					}
                echo "<tr><td bgcolor='#CCCCCC'><strong style='font-size:18px;'>คำถาม :&nbsp;&nbsp;</strong>";
                echo @$mark_ranking[$i]."<strong style='font-size:18px;'>".@$_SESSION['qa_all'][$i]['question_ranking']."</strong>";
                echo anchor('ci_manage_survey/edit_session_after/'.$i.'','<img src="'.base_url().'images/update_icon.png" width="20"/>  ').anchor('ci_manage_survey/unset_session_after/'.$i.'','<img src="'.base_url().'images/delete_icon.png" width="20"/>' , array('onClick' => "return confirm('คุณต้องการลบคำถามใช่หรือไม่?')"));
                echo "<br></td></tr><tr><td><br>";
                ...
                echo "<tr><td bgcolor='#CCCCCC'><strong style='font-size:18px;'>คำถาม :&nbsp;&nbsp;</strong>";
                echo @$mark_ranking_scale[$i]."<strong style='font-size:18px;'>".@$_SESSION['qa_all'][$i]['question_ranking_scale']."</strong>";
                echo anchor('ci_manage_survey/edit_session_after/'.$i.'','<img src="'.base_url().'images/update_icon.png" width="20"/>  ').anchor('ci_manage_survey/unset_session_after/'.$i.'','<img src="'.base_url().'images/delete_icon.png" width="20"/>' , array('onClick' => "return confirm('คุณต้องการลบคำถามใช่หรือไม่?')"));
                echo "<br></td></tr><tr><td>";
                echo "<table width='100%' cellpadding='2' cellspacing='2'><tr><td bgcolor='#F4F4F4' width='50%'>&nbsp;</td>";
                ...
                echo "<tr><td bgcolor='#CCCCCC'><strong style='font-size:18px;'>คำถาม :&nbsp;&nbsp;</strong>";
                echo @$mark_matrix_only[$i]."<strong style='font-size:18px;'>".@$_SESSION['qa_all'][$i]['question_matrix_only']."</strong>";
                echo anchor('ci_manage_survey/edit_session_after/'.$i.'','<img src="'.base_url().'images/update_icon.png" width="20"/>  ').anchor('ci_manage_survey/unset_session_after/'.$i.'','<img src="'.base_url().'images/delete_icon.png" width="20"/>' , array('onClick' => "return confirm('คุณต้องการลบคำถามใช่หรือไม่?')"));
                echo "<br></td></tr><tr><td>";
                echo "<table width='100%' cellpadding='2' cellspacing='2'><tr><td bgcolor='#F4F4F4' width='50%'>&nbsp;</td>";
                ...
                if(@$_SESSION['qa_all'][$i]['check_matrix_multiple']!=""){
					$mark_matrix_multiple[$i] = "<span style='color:red;'>*</span>";
					}
                echo "<tr><td bgcolor='#CCCCCC'><strong style='font-size:18px;'>คำถาม :&nbsp;&nbsp;</strong>";
                echo @$mark_matrix_multiple[$i]."<strong style='font-size:18px;'>".@$_SESSION['qa_all'][$i]['question_matrix_multiple']."</strong>";
                echo anchor('ci_manage_survey/edit_session_after/'.$i.'','<img src="'.base_url().'images/update_icon.png" width="20"/>  ').anchor('ci_manage_survey/unset_session_after/'.$i.'','<img src="'.base_url().'images/delete_icon.png" width="20"/>' , array('onClick' => "return confirm('คุณต้องการลบคำถามใช่หรือไม่?')"));
                echo "<br></td></tr><tr><td>";
                echo "<table width='100%' cellpadding='2' cellspacing='2'><tr><td bgcolor='#F4F4F4' width='50%'>&nbsp;</td>";
                ...
                if($_SESSION['qa_all'][$i]['check_single_textbox']!=""){
					$mark_single_textbox[$i] = "<span style='color:red;'>*</span>";
					$check_single_textbox[$i] = "required='required'";
					}
                echo "<tr><td bgcolor='#CCCCCC'><strong style='font-size:18px;'>คำถาม :&nbsp;&nbsp;</strong>";
                echo @$mark_single_textbox[$i]."<strong style='font-size:18px;'>".@$_SESSION['qa_all'][$i]['question_single_textbox']."</strong>";
                echo anchor('ci_manage_survey/edit_session_after/'.$i.'','<img src="'.base_url().'images/update_icon.png" width="20"/>  ').anchor('ci_manage_survey/unset_session_after/'.$i.'','<img src="'.base_url().'images/delete_icon.png" width="20"/>' , array('onClick' => "return confirm('คุณต้องการลบคำถามใช่หรือไม่?')"));
                echo "<br></td></tr><tr><td><br>";
                echo "<input name='answer_single_textbox' id='answer_single_textbox' class='k-textbox'>"."<br><hr style='border:solid 1px #000000;'>";
                echo "</td></tr>";
                ...
                if(@$_SESSION['qa_all'][$i]['check_mulitple_textbox']!=""){
					$mark_mulitple_textbox[$i] = "<span style='color:red;'>*</span>";
					$check_mulitple_textbox[$i] = "required='required'";
					}
                echo "<tr><td bgcolor='#CCCCCC'><strong style='font-size:18px;'>คำถาม :&nbsp;&nbsp;</strong>";
                echo @$mark_mulitple_textbox[$i]."<strong style='font-size:18px;'>".@$_SESSION['qa_all'][$i]['question_mulitple_textbox']."</strong>";
                echo anchor('ci_manage_survey/edit_session_after/'.$i.'','<img src="'.base_url().'images/update_icon.png" width="20"/>  ').anchor('ci_manage_survey/unset_session_after/'.$i.'','<img src="'.base_url().'images/delete_icon.png" width="20"/>' , array('onClick' => "return confirm('คุณต้องการลบคำถามใช่หรือไม่?')"));
                echo "<br></td></tr><tr><td><br>";
    ...
    <table width="100%" align="center" class="table_radius">
          <tr>
            ...
            <p>&nbsp;
                <a style="cursor:pointer;" onclick="showPage('#home_page1')"><img src="<?php echo base_url()?>images/icon_menu/icon_1.png" width="15"/> คำถามแบบเลือกตอบเพียง 1 คำตอบ</a>
            </p>
            <p>&nbsp;
                <a style="cursor:pointer;" onclick="showPage('#home_page2')"><img src="<?php echo base_url()?>images/icon_menu/icon_2.png" width="15"/> คำถามแบบเลือกตอบหลายคำตอบ</a>
            </p>
            <p>&nbsp;
                <a style="cursor:pointer;" onclick="showPage('#home_page3')"><img src="<?php echo base_url()?>images/icon_menu/icon_3.png" width="15"/>  คำถามแบบคำตอบยาว</a>
            </p>
            <p>&nbsp;
                <a style="cursor:pointer;" onclick="showPage('#home_page4')"><img src="<?php echo base_url()?>images/icon_menu/icon_4.png" width="15"/> ตัวเลือกอันดับ</a>
            </p>
            <p>&nbsp;
                <a style="cursor:pointer;" onclick="showPage('#home_page5')"><img src="<?php echo base_url()?>images/icon_menu/icon_5.png" width="15"/> การจัดลำดับทัศนคติ</a>
            </p>
            <p>&nbsp;
                <a style="cursor:pointer;" onclick="showPage('#home_page6')"><img src="<?php echo base_url()?>images/icon_menu/icon_6.png" width="15"/> คำถามแบบเลือกตอบ 1 คำตอบในรูปแบบเมตริก</a>
            </p>
            <p>&nbsp;
                <a style="cursor:pointer;" onclick="showPage('#home_page7')"><img src="<?php echo base_url()?>images/icon_menu/icon_7.png" width="15"/> คำถามแบบเลือกหลายคำตอบในรูปแบบเมตริก</a>
            </p>
            <p>&nbsp;
                <a style="cursor:pointer;" onclick="showPage('#home_page8')"><img src="<?php echo base_url()?>images/icon_menu/icon_8.png" width="15"/> คำถามคำตอบแบบสั้น</a>
            </p>
            <p>&nbsp;
                <a style="cursor:pointer;" onclick="showPage('#home_page9')"><img src="<?php echo base_url()?>images/icon_menu/icon_9.png" width="15"/> คำถามคำตอบแบบสั้นหลายคำตอบ</a>
            </p>
            <p>&nbsp;
                <a style="cursor:pointer;" onclick="showPage('#home_page10')"><img src="<?php echo base_url()?>images/icon_menu/icon_10.png" width="15"/> วันและเวลา</a>
            </p>
            </td>
            ...
            <div id="midRight"> 
                ...
                <div id="home_page1" style="display:none;"> <?php echo form_open('ci_manage_survey/mulitiple_only_after')?>
                  <p>
                  <table width="95%" align="center">
                    <tr>
                ...
                <div id="home_page2" style="display:none;"> <?php echo form_open('ci_manage_survey/mulitiple_multiple_after')?>
                  <p>
                  <table width="95%" align="center">
                    <tr>
                  ...
                  <?php echo form_close()?> </div>
                <div id="home_page3" style="display:none;"> <?php echo form_open('ci_manage_survey/comment_after')?>
                  <p>
                  <table width="95%" align="center">
                    <tr>
                  ...
                  <?php echo form_close()?> </div>
                <div id="home_page4" style="display:none;"> <?php echo form_open('ci_manage_survey/ranking_after')?>
                  <p>
                  <table width="95%" align="center">
                    <tr>
                  ...
                  <?php echo form_close()?> </div>
                <div id="home_page5" style="display:none;"> <?php echo form_open('ci_manage_survey/ranking_scale_after')?>
                  <p>
                  <table width="95%" align="center">
                    <tr>
                    ...
                    <tr>
                      <td><input name="question_ranking_scale" id="question_ranking_scale" type="text" class="k-textbox" style="width:80%" placeholder="พิมพ์คำถาม" /></td>
                    </tr>
                    <tr>
                      <td><strong>คำถาม</strong></td>
                    </tr>
                  ...
                  <?php echo form_close()?> </div>
                <div id="home_page6" style="display:none;"> <?php echo form_open('ci_manage_survey/matrix_only_after')?>
                  <p>
                  <table width="95%" align="center">
                    <tr>
                  ...
                  <?php echo form_close()?> </div>
                <div id="home_page7" style="display:none;"> <?php echo form_open('ci_manage_survey/matrix_multiple_after')?>
                  <p>
                  <table width="95%" align="center">
                    <tr>
                  ...
                  <?php echo form_close()?> </div>
                <div id="home_page8" style="display:none;"> <?php echo form_open('ci_manage_survey/single_textbox_after')?>
                  <p>
                  <table width="95%" align="center">
                    <tr>
                  ...
                  <?php echo form_close()?> </div>
                <div id="home_page9" style="display:none;"> <?php echo form_open('ci_manage_survey/mulitple_textbox_after')?>
                  <p>
                  <table width="95%" align="center">
                    <tr>
                  ...
                  <?php echo form_close()?> </div>
                <div id="home_page10" style="display:none;"> <?php echo form_open('ci_manage_survey/date_time_after')?>
                  <p>
                  <table width="95%" align="center">
                    <tr>
