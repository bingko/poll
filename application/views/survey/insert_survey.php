  ...
  <tr>
    ...
    <table width="100%" align="center" class="table_radius">
          <tr>
            ...
            <?php echo form_open('ci_manage_survey/mulitiple_choice')?>
            <p><table width="90%" align="center">
              <tr>
                <td><strong>?????</strong></td>
              </tr>
              <tr>
                <td><input name="question_mulitiple_choice" id="question_mulitiple_choice" type="text" class="k-textbox" style="width:80%" /></td>
              </tr>
			  <tr>
                <td><strong>??????????</strong></td>
              </tr>
			  <tr>
                <td><input name="answer_mulitiple_choice" id="answer_mulitiple_choice" type="text" class="k-textbox" style="width:50%" /></td>
              </tr>
			  <tr>
                <td><input name="submit" id="submit" type="submit" value=" ?????? " class="k-button"/></td>
              </tr>
            </table></p>
            <?php echo form_close()?>
            </div>
            <div id="home_page2" style="display:none;"><strong>Mulitiple Choice (Multiple Answer)</strong></div>
            <div id="home_page3" style="display:none;"><strong>Comment</strong></div>
        ...
        <table width="100%">
        <tr>
          	<td align="right"><input type="reset" name="button3" id="button3" value="บันทึก" class="k-button" style="width:100px;"/><a href = "javascript:void(0)" onclick = "document.getElementById('light_question').style.display='none';document.getElementById('fade').style.display='none'"><input type="reset" name="button3" id="button3" value="ยกเลิก" class="k-button" style="width:100px;"/></a></td>
       	  </tr>
        </table>
    </div>
