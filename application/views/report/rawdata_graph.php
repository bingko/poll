<table width="98%" border="0" align="center" cellpadding="3" cellspacing="3" class="table_radius">
    ...
    <div class="alert"><strong>&nbsp;รายงานข้อมูลจริง รูปแบบ Graph</strong></div>
    </td>
  </tr>
      <tr>
        <td valign="top">
        <table id="grid">
                ...
                <?php foreach($survey_list as $survey_list){?>
            		<tr>
						...
						<td><?php echo anchor('report/rawdata_graph/'.$survey_list['qh_id'].'','<input name="submit" type="submit" class="k-button" value="รายงานข้อมูลจริง"/>')?></td>
					</tr>
                <?php } ?>
                </tbody>
            </table>
