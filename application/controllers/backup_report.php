...
class report extends CI_Controller {
	...
	//	$Vdata = @file_get_contents('http://www.t-techsolution.com/'.$file_name);
     //		echo $Vdata;

$curl_handle=curl_init();
curl_setopt($curl_handle, CURLOPT_URL,base_url().'index.php/report/excel_rawdata_table/'.$file_name);
...
curl_close($curl_handle);
		...
		// $url  = "https://www.google.co.th/?gws_rd=ssl";
